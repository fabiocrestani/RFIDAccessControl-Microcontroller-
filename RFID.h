/// \file RFID.h Arquivo de cabeçalho do arquivo RFID.c.
// =======================================================================
// ROTINAS DE COMUNICAÇÃO COM O MÓDULO RFID RC522
// =======================================================================
// Autor: Fábio Crestani
// Última modificação: 16/02/2015
// Insipirado em:
//  http://microcontrolandos.blogspot.com.br/2014/02/pic-rfid-mfrc522.html
//  e https://github.com/ljos/MFRC522
// =======================================================================

// =======================================================================
// Defines
	#define MFRC522_Rst  P1_0	 	
	#define MFRC522_CS	 P1_1
	...
	#define PCD_SOFTRESET		 0x0F 				//Soft Reset
	#define PCD_MEM				 0x01               //Mem
...
// Protótipos
	...
	void GravaTagRFID(char *Tag);	// TODO: gravar tag 
